...
static const char *const autostart[] = {
	...
	"slstatus", NULL,
	"sh", "-c", "~/.fehbg", NULL,
	"sh", "-c", "~/.bin/tumblerd.bin", NULL,
	"sh", "-c", "~/.bin/cursor", NULL,
	"dunst", NULL,
...
static const Rule rules[] = {
	...
	RULE(.class = "Sxiv", .tags = 0, .isfloating = 1, .iscentered = 1, .switchtag = 1)
	...
	RULE(.class = "Xfce4-appearance-settings", .tags = 0, .switchtag = 0, .isfloating = 1, .iscentered =1)
	RULE(.class = "Xfce4-mouse-settings", .tags = 0, .switchtag = 0, .isfloating = 1, .iscentered =1)
	RULE(.class = "Xfce4-settings-manager", .tags = 0, .switchtag = 0, .isfloating = 1, .iscentered =1)
	RULE(.class = "Xfce4-keyboard-settings", .tags = 0, .switchtag = 0, .isfloating = 1, .iscentered =1)
	RULE(.class = "Proton Pass", .tags = 0, .switchtag = 0, .isfloating = 1, .iscentered =1)
	RULE(.title = "About LibreWolf", .tags = 0, .switchtag = 0, .isfloating = 1, .iscentered =1)
...
static const char *volucmd[]  = { "sh", "-c", "/home/dobbie/.bin/volume up", NULL};
static const char *voldcmd[]  = { "sh", "-c", "/home/dobbie/.bin/volume down", NULL};
static const char *exitcmd[]  = { "sh", "-c", "/usr/bin/dmenu_logout", NULL};
static const char *scrotcmd[] = { "sh", "-c", "/home/dobbie/.bin/ss.sh", NULL};
static const char *snipcmd[]  = { "sh", "-c", "/home/dobbie/.bin/sss.sh -m select", NULL};
static const char *timecmd[]  = { "sh", "-c", "/home/dobbie/.bin/sst.sh -m select", NULL};
...
static const Key keys[] = {
	...
	{ MODKEY,		        XK_f,          spawn, 	             {.v = filecmd} },
  	{ ControlMask|ShiftMask,        XK_space,      spawn,                {.v = dunsthcmd} },
  	{ ControlMask,                  XK_space,      spawn,                {.v = dunstccmd} },
	{ MODKEY|ShiftMask,	        XK_e,          spawn,                {.v = nanocmd} },
	{ MODKEY,			XK_l,          spawn, 		     {.v = lockcmd} },
  	{ 0,                            XK_Print,      spawn,                {.v = scrotcmd} },
	{ 0|ShiftMask,                  XK_Print,      spawn,                {.v = snipcmd} },
	{ 0|Mod1Mask,		        XK_Print,      spawn,	             {.v = timecmd} },
