...
static const char *WIN_BG[]   = { "Nsxiv.window.background",   "#141414" };
static const char *WIN_FG[]   = { "Nsxiv.window.foreground",   "#a7a7a7" };
static const char *MARK_FG[]  = { "Nsxiv.mark.foreground",      NULL };
#if HAVE_LIBFONTS
static const char *BAR_BG[]   = { "Nsxiv.bar.background",       "#353535" };
static const char *BAR_FG[]   = { "Nsxiv.bar.foreground",       "#a7a7a7" };
static const char *BAR_FONT[] = { "Nsxiv.bar.font",            "JetBrains Mono Nerd Font-11" };
